...
@export var parry_window_time: float = 0.20
...
func _ready() -> void:
	...
	parry_window_timer.wait_time = parry_window_time
...
func take_hit(other_hitbox: Hitbox) -> void:
	if is_parrying or is_invincible:
		return
